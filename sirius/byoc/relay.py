...
def create_int8_conv_bias_act(x, name, weights_shape, act=False):
    ...
    x = relay.qnn.op.requantize(x, relay.const(1.0), relay.const(0), relay.const(524288.0), relay.const(0), axis=1, out_dtype='int8')
